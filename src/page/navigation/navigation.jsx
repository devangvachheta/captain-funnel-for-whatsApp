    ...
    return (
        <aside className="capfw-sidebar">
            ...
            <div className="capfw-sidebar-logo">
                <div className="capfw-sidebar-logo-icon">
                ...
                <div className="capfw-sidebar-logo-text">
                    <span className="capfw-sidebar-logo-name">WA Funnel</span>
                    <span className="capfw-sidebar-logo-sub">WhatsApp Automation</span>
                </div>
            </div>
